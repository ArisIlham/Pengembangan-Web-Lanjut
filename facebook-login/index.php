...
{	
	...
	$fb_login_url = $fb_helper->getLoginUrl('http://localhost/facebook-login/', $permissions);
}
?>
...
<div class="page-header text-center">
  <h1>Sign in Login with Facebook</h1>
</div>
...
<?php if(isset($_SESSION['fb_user_id'])): ?>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  ...
	  <div class="collapse navbar-collapse" id="collapsibleNavbar">
		<ul class="navbar-nav">
		  <li class="nav-item">
			<a class="nav-link" href="https://www.facebook.com/ArisIlham"><i class="fa fa-facebook">Facebook</i></a>
		  </li>
		  <li class="nav-item">
			<a class="nav-link" href="https://github.com/ArisIlham/"><i class="fa fa-github"> GitHub</i></a>
		  </li>
		  <li class="nav-item">
